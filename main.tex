...
\begin{figure}[H]
    \centering
    \includegraphics{pictures/somatosensory/somato_Pr5.png}
    \caption[Lage des Nucleus principalis des Trigeminus]{\textbf{Lage des Nucleus principalis des Trigeminus}\\
    Inferiore Olive (IO)}
