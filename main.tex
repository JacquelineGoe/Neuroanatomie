...
\begin{figure}[H]
    ...
    \cite{crossman2014neuroanatomy} S.~79}
...
ventral posterior nuclei) verarbeitet. Proprioceptive Informationen aus den Gelenken und dem Bauchraum werden über den medialen Lemniscus an den oberen Nucleus ventralis posterior (eng.: superior ventral posterior nucleus) weitergeleitet \cite[Kap.~22]{kandel2013principles}. 
...
\textcolor{red}{Auf die Abbildung in der Einleitung mit den Nuclei des Thalamus verweisen.}
...
\begin{figure}
    ...
    \caption[Primärer Somatosensorischer Cortex]{\textbf{Primärer Somatosensorischer Cortex} 
    \cite[Kap.~23]{kandel2013principles}}
    \label{fig:S1_Cortex}
\end{figure}
...
\begin{itemize}
    \item Wie bei allen anderen Sinnessystemen auch, findet die komplexeste Verarbeitung somatosensorischer Informationen in der Großhirnrinde statt. Der für die somatosensorische Wahrnehmung zuständige Cortexbereich befindet sich im Parietallappen (Abb.12.17). Das Brodmann-Areal 3b, das jetzt als primärer somatosensorischer Cortex (S1) bezeichnet wird, kann beim Menschen leicht lokalisiert werden: Es liegt auf dem postzentralen Gyrus, also der ersten Hirnwindung direkt hinter der Zentralfurche. (Siehe hierzu auch Abb.Abb. 7.32, in der die Brodmann-Areale dargestellt sind.) S1 wird von weiteren Cortexarealen flankiert, die ebenfalls an der Verarbeitung somatosensorischer Information beteiligt sind. Hierzu zählen die Areale 3a, 1 und 2 auf dem postzentralen Gyrus sowie die Areale 5 und 7 auf dem benachbarten posterioren Parietalcortex (Abb.12.17).
    \item Das Areal 3b (Area 3b) bildet den primären somatosensorischen Cortex, weil (1)es sehr viele Afferenzen vom VP-Kern des Thalamus empfängt, (2)seine Neuronen sehr gut auf taktile Reize (aber auf keine anderen sensorischen Reize) ansprechen, (3)Läsionen in diesem Bereich die somatosensorische Wahrnehmung beeinträchtigen und (4) eine elektrische Stimulation dieser Region somatosensorische Wahrnehmungen hervorrufen kann. Das Areal 3a empfängt zwar ebenfalls zahlreiche Inputs vom Thalamus, seine Funktion besteht jedoch eher in der Wahrnehmung der Körperhaltung und des Schmerzes als in der Verarbeitung von Berührungsreizen.
Die Areale 1 und 2 erhalten dichte Eingänge vom Areal 3b. Während über die Projektion von 3b zu Areal 1 vornehmlich Informationen über die strukturelle Beschaffenheit des Reizes weitergegeben werden, leitet die Projektion zu Areal 2 hauptsächlich Informationen bezüglich der Größe und der Gestalt weiter. Kleine Läsionen innerhalb der Areale 1 oder 2 verursachen vorhersagbare Ausfälle im Unterscheidungsvermögen von Textur, Größe und Gestalt des auslösenden Reizes.
Der somatosensorische Cortex besitzt, wie andere Regionen des Neocortex auch, eine geschichtete Struktur. Ebenso wie im Falle des visuellen und des auditorischen Cortex münden die vom Thalamus an S1 weitergeleiteten Signale hauptsächlich in Schicht IV. Die Neuronen dieser Schicht wiederum projizieren zu den Zellen anderer Schichten. Eine weitere wichtige Ähnlichkeit mit anderen Regionen des Cortex besteht darin, dass S1-Neuronen, die gleichartige Signale empfangen und weiterleiten, in vertikalen Kolumnen organisiert sind, die sich über die verschiedenen cortikalen Schichten erstrecken (Abb. 12.18). Das Konzept der cortikalen Kolumne, das von Hubel und Wiesel so anschaulich für den visuellen Cortex ausgearbeitet wurde, war ursprünglich eigentlich im Zusammenhang mit dem somatosensorischen Cortex von Vernon Mountcastle an der Johns Hopkins University beschrieben worden.
\end{itemize}
...
\begin{figure}
        \centering
        \includegraphics{pictures/somatosensory/gray_matter.png}
        ...
        \cite{crossman2014neuroanatomy} S.~74}
