...
\subsubsection*{Waschen}
Zuerst werden die Schnitte sieben Mal für jeweils fünf Minuten in TBS-Puffer (Phosphate-buffered Saline) gewaschen. Anschießend werden die Schnitte für zwanzig Minuten in TBS-Puffer mit 0.3~\% H\textsubscript{2}O gelegt, um danach erneut sieben Mal für jeweils fünf Minuten in TBS gewaschen zu werden.

\subsubsection*{Quenching}
Das Quenching (dt.: (Flammen-)Löschen) beugt unspezifiescher Hintergrundfärbung vor. Dafür werden die endogenen Peroxidasen mittels Wasserstoffperoxidase H\textsubscript{2}O\textsubscript{2} abreagiert. Somit können diese nicht mit Stoffen reagieren, die in späteren Färbeschritten verwendet werden. Dafür werden die Gehirnschnitte für eine Stunde in Blocker gelegt werden.




\subsection{BILDERAUFNAHME?}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
